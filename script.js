...
//   Decide the grid area
      c.grid.append("g").attr("class", "vertical").call(d3.axisLeft(c.y).tickValues(c.y.ticks(100)).tickFormat("").tickSize(-c.width));
